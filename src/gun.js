...
export const PAINTS = {
  ...
  bronze: { 1: '#5a3418', 2: '#9a5f2e', 3: '#cf8e52', 5: '#f2d8b0', 6: '#b58a60', 9: '#3a2210', 10: '#6e4424' },
  diamond: { 1: '#1d6e84', 2: '#4cc4dc', 3: '#aef0ff', 5: '#ffffff', 6: '#8fe8f8', 9: '#164e5e', 10: '#2f94ac', camo: true },
  lava: { 1: '#1a0f0c', 2: '#2c1a14', 3: '#44261a', 5: '#ff7a2f', 6: '#d83a1a', 9: '#120a08', 10: '#24140f', neon: true },
};
